...
def demo_inference() -> None:
    ...
    cw_predictor = CheckworthyClaimDetector(countries=["GBR"])
...
def learn_weights(training_examples_file: str, new_model_file: str) -> None:
    ...
    """
    pastelizer = pastel.Pastel(MODEL_QUESTIONS)
...
if __name__ == "__main__":
    demo_inference()
    # learn_weights("data/ff_checkworthy.csv", CHECKWORTHY_MODEL_FILE)
